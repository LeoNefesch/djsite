...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('researchers', '0002_category_researchers_cat'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='researchers',
            options={'ordering': ['-time_create', 'title'], 'verbose_name': 'Известные исследователи', 'verbose_name_plural': 'Известные исследователи'},
        ),
        ...
        migrations.AlterField(
            ...
            name='cat',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='researchers.category', verbose_name='Категории'),
        ),
        migrations.AlterField(
            model_name='researchers',
            name='content',
